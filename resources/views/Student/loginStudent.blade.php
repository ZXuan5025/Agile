...
<div class="container1">
    ...
    <form method="POST"  action="/loginStudentsubmit">
        @csrf
		<label>
			<span class="label-text1">Email</span>
			<input type="text" id="email" name="email" placeholder="Email"  maxlength="30" required="required" value="{{old('email')}}" >
		</label>
        <label>
			<span class="label-text1">Password</span>
			<input type="text" id="password" name="password" placeholder="PAssword"  maxlength="50" required="required" value="{{old('password')}}" >
		</label>
